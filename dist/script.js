...
/* harmony import */ var _validators_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./validators.component */ "./src/js/modules/validators.component.js");
/* harmony import */ var _services_request_services__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./../services/request.services */ "./src/js/services/request.services.js");
...
function forms(selectorForms) {
  ...
  upload.forEach(function (input) {
    return _inputTypeFile(input, infoPhoto);
  });

  _formsAddSubmitHandler(forms, _formSubmitHandler);

  function _formSubmitHandler(e) {
    var item, validObj, api, form, _createStatusModal2, messageElm, statusImg, textMessage, data;
...
function _defineFormAndSetValidAndUrl(form, validObj, path) {
  if (form.closest('.popup-design') || form.classList.contains('consul_form')) {
    validObj.name = [_validators_component__WEBPACK_IMPORTED_MODULE_12__["default"].required];
    validObj.phone = [_validators_component__WEBPACK_IMPORTED_MODULE_12__["default"].required];
    validObj.email = [_validators_component__WEBPACK_IMPORTED_MODULE_12__["default"].required];
    validObj.message = [_validators_component__WEBPACK_IMPORTED_MODULE_12__["default"].required, _validators_component__WEBPACK_IMPORTED_MODULE_12__["default"].minLength(15)];
    return path.design;
...
function _inputTypeFile(input, infoPhoto) {
  var button = input.closest('.file_upload').querySelector('button');
...
function () {
  function Modal(modalSel, buttonOpenSel) {
    ...
    var animationClass = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'fadeIn';
    ...
    value: function showWithDelay(delay) {
      ...
      setTimeout(function () {
        ...
        document.querySelectorAll('[data-modal]').forEach(function (modal) {
          if (modal.classList.contains(_this2.classShow)) display = true;
        });
        if (!display) _this2.emulatedClick();
      }, delay);
    }
  }, {
    key: "openByScroll",
    value: function openByScroll() {
...
/***/ "./src/js/modules/showmoreinf.component.js":
/*!*************************************************!*\
  !*** ./src/js/modules/showmoreinf.component.js ***!
  \*************************************************/
/*! exports provided: showMoreInfFromServer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showMoreInfFromServer", function() { return showMoreInfFromServer; });
...
/* harmony import */ var _services_request_services__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./../services/request.services */ "./src/js/services/request.services.js");
...
var showMoreInfFromServer = function showMoreInfFromServer(sectionSel, cardParentSel, trigger) {
  var section = document.querySelector(sectionSel);
  var button = section.querySelector(trigger);
  var cardParent = section.querySelector(cardParentSel);
  button.addEventListener('click', function () {
    _services_request_services__WEBPACK_IMPORTED_MODULE_6__["default"].getRequest('assets/db.json').then(function (response) {
...
var tabs = function tabs(section, tabsParent, contentParent) {
  var $section = document.querySelector(section);
  var $tabsParent = $section.querySelector(tabsParent);
  var $contentParent = $section.querySelector(contentParent);
  var $contentItems = $contentParent.querySelectorAll('.portfolio-block');
  var prevValue;
  ...
  function _tabClickHandler(e) {
    ...
    if (target && target.tagName === 'LI') {
      var filterClass = target.classList[0];
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              request = new Request(url);
              return _context2.abrupt("return", _useRequest(request));
...
function _useRequest(request) {
  var response;
  return regeneratorRuntime.async(function _useRequest$(_context3) {
    while (1) {
